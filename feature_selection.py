...
def select_features_from_paper(df, group, key):
    ...
    if group == "young":
        ...
        strings=["g__Peptostreptococcus","g__Parvimonas", "g__Streptococcus", "g__UCG 002", "g__Lachnospiraceae NC2004 group", "g__Escherichia_Shigella",
                 ...
                 "f__[Eubacterium] coprostanoligenes group", "g__Atopobium", "g__Catenibacterium",
                 "f__Butyricicoccaceae", "f__Xanthomonadaceae", "f__Porphyromonadaceae", "f__Oscillospiraceae",
                 "f__Family XI", "f__Lachnospiraceae", "f__Streptococcaceae", "f__Marinifilaceae", "f__Erysipelatociostridiaceae",
                 "f__Micrococcaceas", "f__Ruminococcaceae","f__Christensenellaceae", "f__Clostridiaceae", "f__Burkholderiaceae ", "f__Staphylococcaceae",
                 "f__Coriobacterlaceae", "f__Caulobacteraceae", "f__[Clostridium] methylpentosum group", "f__Helicobacteracea"]
