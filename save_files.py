...
def save_data(FUDAN, fudan_filepath, group, select_features):
    ...
    if select_features == True:
        ...
        X_train.to_csv(os.path.join(Config.DATA_DIR, 'preprocessed',  group, f"selected_features/X_train"))
        X_val.to_csv(os.path.join(Config.DATA_DIR, 'preprocessed',  group, f"selected_features/X_val"))
        y_train.to_csv(os.path.join(Config.DATA_DIR, 'preprocessed',  group, f"selected_features/y_train"))
        y_val.to_csv(os.path.join(Config.DATA_DIR, 'preprocessed',  group, f"selected_features/y_val"))
    if select_features == False:
        ...
        y_train = pd.DataFrame(y_train)
        y_val = pd.DataFrame(y_val)
        X_train.to_csv(os.path.join(Config.DATA_DIR, 'preprocessed', group, f"all_features/X_train"))
        X_val.to_csv(os.path.join(Config.DATA_DIR, 'preprocessed', group, f"all_features/X_val"))
        y_train.to_csv(os.path.join(Config.DATA_DIR, 'preprocessed', group, f"all_features/y_train"))
        y_val.to_csv(os.path.join(Config.DATA_DIR, 'preprocessed', group, f"all_features/y_val"))
